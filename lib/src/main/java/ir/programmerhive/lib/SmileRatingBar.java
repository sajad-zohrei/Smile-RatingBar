...
public class SmileRatingBar extends AppCompatRatingBar {
    ...
    private int[] iconArrayInactive = {
            R.drawable.ic_sentiment_very_dissatisfied_inactive,
            R.drawable.ic_sentiment_dissatisfied_inactive,
            R.drawable.ic_sentiment_neutral_inactive,
            R.drawable.ic_sentiment_satisfied_inactive,
            R.drawable.ic_sentiment_very_satisfied_inactive
    };
    ...
    public SmileRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SmileRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int default_icon_size = icon_size;
        ...
        for (int i = 0; i < stars; i++) {
            if ((int) rating - 1 == i) {
                ...
                icon_size = default_icon_size+10 ;
            } else {
